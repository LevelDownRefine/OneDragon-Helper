...
执行状态: 完成
执行轮数: 1"""
        self.assertEqual(_parse_ok_ef(log_content), ScriptLogStatus.SUCCESS)

    def test_parse_ok_ef_failed(self):
        log_content = """日常任务执行情况汇总 - 2026-07-19 21:08:34
==================================================
执行状态: 异常结束"""
        self.assertEqual(_parse_ok_ef(log_content), ScriptLogStatus.FAILED)
...
异常信息: xxx"""
    ...
    def test_parse_ok_ww_success(self):
        ...
        self.assertEqual(_parse_ok_ww(log_content), ScriptLogStatus.SUCCESS)
    ...
    def test_parse_ok_ww_failed(self):
        ...
        self.assertEqual(_parse_ok_ww(log_content), ScriptLogStatus.FAILED)
...
2026-07-19 15:24:50,234 | ERROR | 发生错误 [WinError 233]"""
        self.assertEqual(_parse_m7a(log_content), ScriptLogStatus.SUCCESS)

    def test_parse_m7a_failed(self):
        log_content = """ERROR: 任务执行失败
ERROR: 另一个错误"""
        self.assertEqual(_parse_m7a(log_content), ScriptLogStatus.FAILED)
