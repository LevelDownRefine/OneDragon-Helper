"""测试 src/gui/state.py：apply_weekly_timeout 的覆盖规则。"""
import unittest
from unittest.mock import patch

from src.gui.state import DEFAULT_RUN_TIMEOUT, apply_weekly_timeout
...
class TestApplyWeeklyTimeout(unittest.TestCase):
    ...
    @patch("src.gui.state.get_week_num", return_value=1)
